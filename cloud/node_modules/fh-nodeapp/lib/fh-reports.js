...
exports.sendReport = function (opts) {
  ...
  process.nextTick(function () {
    ...
    var msgconfig = {host:process.env.FH_MESSAGING_HOST,
      cluster:process.env.FH_MESSAGING_CLUSTER,
      msgServer:{logMessageURL:process.env.FH_MESSAGING_SERVER},
      backupFiles:{fileName:process.env.FH_MESSAGING_BACKUP_FILE},
      recoveryFiles:{fileName:process.env.FH_MESSAGING_RECOVERY_FILE}
    };
    var msg;
...
function createFHActReport (opts) {
  ...
  if (opts.hasOwnProperty('fullparams')) {
    report = {guid:process.env.FH_INSTANCE, 'domain':process.env.FH_DOMAIN};
    var fullparams = opts.fullparams;
    var  _fh = fullparams.__fh || {};
    var  head = fullparams._headers || {};
